...
<div class="page-shell">
    ...
    <div class="search-section">
        <div class="input-group">
            <input autocomplete="off" type="text" class="form-control" id="search_clims_id" placeholder="Enter CLIMS ID (e.g., CLIMS-NTPC-2026-001)">
            <button class="btn btn-primary" id="searchBtn">
                <i class="fas fa-search me-2"></i> Search
            </button>
            <button class="btn btn-outline-secondary" id="refreshBtn" title="Refresh data from database">
            ...
            <div class="row g-3">
                ...
                ?>
                    <div class="col-lg-3">
                        ...
                        <select id="<?php echo htmlspecialchars($fieldName, ENT_QUOTES, 'UTF-8'); ?>" class="form-select" name="<?php echo htmlspecialchars($fieldName, ENT_QUOTES, 'UTF-8'); ?>">
        ...
        <section class="clims-section" data-step="3" id="section3">
            ...
            <div class="row g-3">
                <div class="col-lg-2"><label class="form-label" for="height">Height (cm)</label>
                    <input type="number" step="0.01" class="form-control" name="height" id="height"></div>
                <div class="col-lg-2"><label class="form-label" for="weight">Weight (kg)</label>
                    <input type="number" step="0.01" class="form-control" name="weight" id="weight"></div>
                <div class="col-lg-2"><label class="form-label" for="bp">BP (mmHg)</label>
                    <input type="text" class="form-control" name="bp" id="bp"></div>
                <div class="col-lg-2"><label class="form-label" for="bmi">BMI</label>
                    <input type="text" class="form-control" name="bmi" id="bmi" readonly></div>
                <div class="col-lg-2"><label class="form-label" for="chest_insp">Chest (Inspiration)</label>
                    <input type="text" class="form-control" name="chest_insp" id="chest_insp"></div>
                <div class="col-lg-2"><label class="form-label" for="chest_exp">Chest (Expiration)</label>
                    <input type="text" class="form-control" name="chest_exp" id="chest_exp"></div>
                <div class="col-lg-3"><label class="form-label" for="pulse_spo2_temp">Pulse/SPO2/Temp</label>
                    <input type="text" class="form-control" name="pulse_spo2_temp" id="pulse_spo2_temp"></div>
                <div class="col-lg-2"><label class="form-label" for="pallor">Pallor</label>
                    <select class="form-select" name="pallor" id="pallor"><option value="">Select</option><option value="Present">Present</option><option value="Absent">Absent</option></select></div>
                <div class="col-lg-2"><label class="form-label" for="icterus">Icterus</label>
                    <select class="form-select" name="icterus" id="icterus"><option value="">Select</option><option value="Present">Present</option><option value="Absent">Absent</option></select></div>
                <div class="col-lg-2"><label class="form-label" for="clubbing">Clubbing</label>
                    <select class="form-select" name="clubbing" id="clubbing"><option value="">Select</option><option value="Present">Present</option><option value="Absent">Absent</option></select></div>
                <div class="col-lg-3"><label class="form-label" for="built">Built</label>
                    <select class="form-select" name="built" id="built"><option value="">Select</option><option value="Thin">Thin</option><option value="Medium">Medium</option><option value="Obese">Obese</option></select></div>
                <div class="col-lg-3"><label class="form-label" for="tongue">Tongue</label>
                    <input type="text" class="form-control" name="tongue" id="tongue"></div>
                <div class="col-lg-3"><label class="form-label" for="teeth">Teeth</label>
                    <input type="text" class="form-control" name="teeth" id="teeth"></div>
                <div class="col-lg-6"><label class="form-label" for="other_finding">Any Other Finding</label>
                    <textarea class="form-control" rows="2" name="other_finding" id="other_finding"></textarea></div>
            </div>
        </section>
        ...
        <section class="clims-section" data-step="4" id="section4">
            ...
            <div class="row g-3">
                <div class="col-lg-6"><label class="form-label" for="cardio_system">Cardiovascular System</label>
                    <textarea class="form-control" rows="2" name="cardio_system" id="cardio_system"></textarea></div>
                <div class="col-lg-6"><label class="form-label" for="respiratory_system">Respiratory System</label>
                    <textarea class="form-control" rows="2" name="respiratory_system" id="respiratory_system"></textarea></div>
                <div class="col-lg-6"><label class="form-label" for="cns">CNS</label>
                    <textarea class="form-control" rows="2" name="cns" id="cns"></textarea></div>
                <div class="col-lg-6"><label class="form-label" for="system_other">Any Other Findings</label>
                    <textarea class="form-control" rows="2" name="system_other" id="system_other"></textarea></div>
            </div>
        </section>
        ...
        <section class="clims-section" data-step="5" id="section5">
            ...
            <div class="table-responsive">
                <table class="table table-bordered vision-table align-middle">
                    ...
                    <tbody>
                        <tr class="fw-bold">DISTANT VISION</tr>
                        <tr>
                            <td class="fw-bold">Distant Vision</td>
                            <td><select class="form-select" name="distant_r_with"><option value="">Select</option><option>6/6</option><option>6/9</option><option>6/12</option><option>6/18</option><option>6/24</option><option>6/36</option><option>6/60</option></select></td>
                            <td><select class="form-select" name="distant_r_without"><option value="">Select</option><option>6/6</option><option>6/9</option><option>6/12</option><option>6/18</option><option>6/24</option><option>6/36</option><option>6/60</option></select></td>
                            <td><select class="form-select" name="distant_l_with"><option value="">Select</option><option>6/6</option><option>6/9</option><option>6/12</option><option>6/18</option><option>6/24</option><option>6/36</option><option>6/60</option></select></td>
                            <td><select class="form-select" name="distant_l_without"><option value="">Select</option><option>6/6</option><option>6/9</option><option>6/12</option><option>6/18</option><option>6/24</option><option>6/36</option><option>6/60</option></select></td>
                        </tr>
                        <tr>
                            <td class="fw-bold">Near Vision</td>
                            <td><select class="form-select" name="near_r_with"><option value="">Select</option><option>N5</option><option>N6</option><option>N8</option><option>N10</option><option>N12</option><option>N18</option></select></td>
                            <td><select class="form-select" name="near_r_without"><option value="">Select</option><option>N5</option><option>N6</option><option>N8</option><option>N10</option><option>N12</option><option>N18</option></select></td>
                            <td><select class="form-select" name="near_l_with"><option value="">Select</option><option>N5</option><option>N6</option><option>N8</option><option>N10</option><option>N12</option><option>N18</option></select></td>
                            <td><select class="form-select" name="near_l_without"><option value="">Select</option><option>N5</option><option>N6</option><option>N8</option><option>N10</option><option>N12</option><option>N18</option></select></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="row g-3 mt-1">
                <div class="col-lg-6"><label class="form-label" for="colour_vision">Colour Vision</label>
                    <input type="text" class="form-control" name="colour_vision" id="colour_vision"></div>
                <div class="col-lg-6"><label class="form-label" for="eye_disorder">Any Eye Related Disorder</label>
                    <textarea class="form-control" rows="2" name="eye_disorder" id="eye_disorder"></textarea></div>
            </div>
        </section>

        <!-- SECTION 6: FOR FEMALE WORKERS -->
        <section class="clims-section" data-step="6" id="section6">
            ...
            <div class="row g-3">
                <div class="col-lg-4"><label class="form-label" for="lmp">Last Menstrual Period</label>
                    <input type="text" class="form-control" name="lmp" id="lmp"></div>
                <div class="col-lg-4"><label class="form-label" for="menstrual_cycle">Menstrual Cycle</label>
                    <select class="form-select" name="menstrual_cycle" id="menstrual_cycle"><option value="">Select</option><option value="Regular">Regular</option><option value="Irregular">Irregular</option><option value="Not Applicable">Not Applicable</option></select></div>
                <div class="col-lg-4"><label class="form-label" for="pregnancy_duration">Pregnancy Duration</label>
                    <input type="text" class="form-control" name="pregnancy_duration" id="pregnancy_duration"></div>
            </div>
        </section>
        ...
        <section class="clims-section" data-step="7" id="section7">
            ...
            <div class="row g-3">
                <div class="col-lg-4"><label class="form-label" for="cbc">CBC</label>
                    <input type="text" class="form-control" name="cbc" id="cbc"></div>
                <div class="col-lg-4"><label class="form-label" for="random_blood_sugar">Random Blood Sugar</label>
                    <input type="text" class="form-control" name="random_blood_sugar" id="random_blood_sugar"></div>
                <div class="col-lg-4"><label class="form-label" for="urine_rm">Urine R&amp;M</label>
                    <input type="text" class="form-control" name="urine_rm" id="urine_rm"></div>
                <div class="col-lg-3"><label class="form-label" for="blood_group">Blood Group</label>
                    <select class="form-select" name="blood_group" id="blood_group"><option value="">Select</option><option>A+</option><option>A-</option><option>B+</option><option>B-</option><option>O+</option><option>O-</option><option>AB+</option><option>AB-</option></select></div>
                <div class="col-lg-3"><label class="form-label" for="lft_kft">LFT/KFT</label>
                    <input type="text" class="form-control" name="lft_kft" id="lft_kft"></div>
                <div class="col-lg-2"><label class="form-label" for="ecg">ECG</label>
                    <select class="form-select" name="ecg" id="ecg"><option value="">Select</option><option value="Normal">Normal</option><option value="Abnormal">Abnormal</option></select></div>
                <div class="col-lg-2"><label class="form-label" for="chest_xray">Chest X-Ray</label>
                    <select class="form-select" name="chest_xray" id="chest_xray"><option value="">Select</option><option value="Normal">Normal</option><option value="Abnormal">Abnormal</option></select></div>
                <div class="col-lg-2"><label class="form-label" for="height_pass_test">Height Pass Test</label>
                    <select class="form-select" name="height_pass_test" id="height_pass_test"><option value="">Select</option><option value="Pass">Pass</option><option value="Fail">Fail</option></select></div>
                <div class="col-12"><label class="form-label" for="other_tests">Other Tests</label>
                    <textarea class="form-control" rows="2" name="other_tests" id="other_tests"></textarea></div>
            </div>
        </section>

        <!-- SECTION 8: OPINION & REMARKS -->
        <section class="clims-section" data-step="8" id="section8">
            ...
            <div class="row g-3">
                ...
                <div class="col-12"><label class="form-label" for="remarks">Remarks</label>
                    <textarea class="form-control" rows="3" name="remarks" id="remarks"></textarea></div>
                <div class="col-lg-6"><label class="form-label" for="worker_signature">Worker Signature</label>
                    <input type="text" class="form-control" name="worker_signature" id="worker_signature"></div>
                <div class="col-lg-6"><label class="form-label" for="doctor_signature">Doctor Signature</label>
                    <input type="text" class="form-control" name="doctor_signature" id="doctor_signature"></div>
            </div>
        </section>

        <div class="footer-actions d-flex flex-wrap justify-content-center gap-2">
            <button type="button" class="btn btn-gradient btn-pill" id="saveAllBtn">
